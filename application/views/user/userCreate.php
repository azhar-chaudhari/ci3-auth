    ...
    <section class="content">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <form id="norm_form" method="post" action="<?php echo site_url($verb . '/create') ?>"
                            ...
                            <div class="row p-1">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        placeholder="Enter Name"
                                            aria-describedby="name" value="<?php echo set_value('name'); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        placeholder="Enter Mobile No."
                                            aria-describedby="mobile" value="<?php echo set_value('mobile'); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter Email"
                                            aria-describedby="email" value=" <?php echo set_value('email'); ?>">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        aria-describedby="password" value=" <?php echo set_value('password'); ?>">
